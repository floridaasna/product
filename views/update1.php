...
if (isset($_GET['id'])) {
  ...
  $categorye = $categorydb ->read($product->categoryId);
    ...
    <div class="col-md-8 offset-2 ">
      <div class="card shadow mb-4">
        ...
        <div class="collapse show" id="collapseCardExample">
          ...
          ?>
            <div class="card-body">
              <form method="POST" action="../controllers/productControllers.php?action=update " enctype="multipart/form-data">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="name" class="form-control" id="nom" aria-describedby="emailHelp" name="nom" value="<?php echo $product->nom; ?>">
...
?>
<div>
  <img src="../image/<?php echo $product->image;?>" alt="image existante" widht="75" height="75">
</div>
<?php endif; ?>
                ...
                <div class="mb-3">
                  ...
                  <select class="form-control" name="categoryId" id="categoryId">
                    <option value="<?php echo $categorye ->categoryId ?>" style="display:none;">
                      <?php  echo $categorye->libelle;
